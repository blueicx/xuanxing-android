...
object FunTests3 {
    ...
    val SUBTESTS: List<Fun3SubtestInfo> = listOf(
        ...
        Fun3SubtestInfo("FBTI", "FBTI 美食人格（原创）", "8 题 · 16 种人格", "以美食意象做 MBTI 风格的趣味类比，不是官方 MBTI 测评。"),
        Fun3SubtestInfo("Raven", "文字推理挑战（原创）", "10 题 · 推理题", "通过数列与类比进行趣味练习，不是标准瑞文非语言推理测验。")
    )
